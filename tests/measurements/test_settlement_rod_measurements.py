...
def test_settlement_rod_measurement_init_with_valid_input() -> None:
    ...
    ground_plate_z = -1.193
    ground_plate_z_uncorrected = -1.193
    temperature = 12.0
    voltage = 4232
    comment = "No comment"
    ...
    assert measurement.point_x == point_x
    assert measurement.point_y == point_y
    assert measurement.point_z == point_z
    assert measurement.rod_length == rod_length
    assert measurement.ground_surface_z == ground_surface_z
    assert measurement.ground_plate_z == ground_plate_z
    assert measurement.ground_plate_z_uncorrected == ground_plate_z_uncorrected
